...
import HistoricalQuote from "./views/HistoricalQuotation/HistoricalQuotation.jsx"
...
export default (
  <Router history={hashHistory}>
    <Route path="/" name="Home" component={Home}>
      ...
      <Route path="historical_quotation" name="historical_quotation" component={HistoricalQuote}/>
